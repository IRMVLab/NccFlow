...
from NccFlow.nccflow_data import data_utils
# pylint:disable=unused-import
from NccFlow.nccflow_data.data_utils import evaluate
from NccFlow.nccflow_data.data_utils import list_eval_keys
...
def make_dataset(path,
                 ...
                 resize_gt_flow=True,
                 seed=41):
  """Make a dataset for training or evaluating Nccflow in nccflow_main.
...
def benchmark(inference_fn,
  ...
  for index, test_batch in enumerate(it):
    ...
    if plot_dir and plot_count < num_plots:
      ...
      subplot_at(0, 1)
      plt.imshow(plotting.flow_to_rgb(flow))
      ...
      plotting.save_and_close(os.path.join(plot_dir, filename))
