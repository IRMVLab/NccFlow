...
# Lint as: python3
"""Flags used by nccflow training and evaluation."""
...
flags.DEFINE_integer('num_train_steps', int(4000000),
                     'Number of gradient steps to train for.')
flags.DEFINE_integer('selfsup_after_num_steps', int(100000),
                     'Number of gradient steps before self-supervision.')
flags.DEFINE_integer('selfsup_ramp_up_steps', int(100000),
...
flags.DEFINE_float('gpu_learning_rate', 1e-4, 'Learning rate for training '
                   'NccFlow on GPU.')
flags.DEFINE_integer('lr_decay_after_num_steps', 300000, '')
flags.DEFINE_integer('lr_decay_steps', 200000, '')
...
flags.DEFINE_float('weight_intersect', 0.01, 'Weight for intersect loss.')
flags.DEFINE_float('weight_flow_blocked', 0.01, 'weight for flow_blocked loss.')
...
flags.DEFINE_string('occlusion_estimation', 'brox',
