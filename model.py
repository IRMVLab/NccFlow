...
This library contains the models used in NccFlow. Our model is a slightly modified
  ...
  def call(self, feature_pyramid1, feature_pyramid2, training=False):
    ...
    for level, (features1, features2) in reversed(
      ...
      if flow_up is None or not self._use_feature_warp:
        ...
        warp_up = utils.flow_to_warp(flow_up)
        warped2 = utils.resample(features2, warp_up)
      ...
      flow_up = utils.upsample(flow, is_flow=True)
      if self._num_context_up_channels:
